...
if (submitted) {
  ...
  return (
    <>
       <h1>Signup</h1>  
       { incorrectEmailEntered && <label className="incorrectemail">Please enter a valid email<br /></label> }  
       { incorrectEduEmailAccount && <label className="incorrectemail">Please enter an edu account email<br /></label> }  
      <input
        type="email"
        placeholder="Email"
      ...
      />
      <br />
      {incorrectPassword && <label className="incorrectemail">Please enter a valid password
      Password cant be Empty, Password length must be greater than 8 characters and less than 15 characters<br /></label> }  
      <input
        type="password"
